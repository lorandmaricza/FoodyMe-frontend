...
function ManageCategories() {
    ...
    const handleUpdateCategory = async () => {
        const response = await fetch('http://localhost:8888/final-project-back-end/public/category/update-category.php', {
                    method: 'POST',
    ...
    const handleDeleteCategory = async (category_id) => {
        const response = await fetch('http://localhost:8888/final-project-back-end/public/category/delete-category.php', {
            method: 'POST',
    ...
    const handleAddCategory = async () => {
        const response = await fetch('http://localhost:8888/final-project-back-end/public/category/add-category.php', {
            method: "POST",
