        ...
        <div>
            ...
            <div className={classes.wrapperDiv}>
                <div className={isEditing ? classes.editSubWrapperDiv : classes.subWrapperDiv}>
                    <h1 className={classes.header}>Welcome {user.firstName}!</h1>
                    <h2>{passwordError}</h2>
                    <div>
                        {!isEditing ?
                            <div className={classes.inputEditWrapperDiv}>
                                <p>Role: </p>
                                <b>{getRole(user.roleId)}</b>
                            </div> : <></>}
                        <div className={classes.inputEditWrapperDiv}>
                            <p>Email: </p>
                            {isEditing ? <input type="text" name="email" value={updatedData.email} className={classes.textInput} onChange={handleChange} /> : <b>{user.email}</b>}
                        </div>
                        <div className={classes.inputEditWrapperDiv}>
                            <p>First Name: </p>
                            {isEditing ? <input type="text" name="first_name" value={updatedData.firstName} className={classes.textInput} onChange={handleChange} /> : <b>{user.firstName}</b>}
                        </div>
                        <div className={classes.inputEditWrapperDiv}>
                            <p>Last Name: </p>
                            {isEditing ? <input type="text" name="last_name" value={updatedData.lastName} className={classes.textInput} onChange={handleChange} /> : <b>{user.lastName}</b>}
                        </div>
                        {isEditing && (
                            <div className={classes.inputEditWrapperDiv}>
